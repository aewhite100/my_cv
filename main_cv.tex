...
\begin{minipage}{0.44\linewidth}
  \begin{tabular}{ll}
    ...
    website: \href{https://datascience.si.edu/people/dr-alex-white}{\tt datascience.si.edu}
  \end{tabular}
\end{minipage}
...
\begin{itemize}
  ...
  \\ \emph{Best Dissertation}, Biological Sciences Division
...
\begin{biblist} 
\item Romero I, Wing SL, Jaramillo CA, Little H, Punyasena SW, \textbf{White AE}. In review. Digitizing microscope slide-based Natural History Collections: A protocol using slide scanner technology.
...
\item Hodel R, Winslow S, Xie SY, Liu BB, Zhao L, Johnson G, Trizna M, \textbf{White AE}, Dikow R, Potter D, Zimmer E, Wen J. In press. A phylogenomic approach combined with morphological characters gleaned via machine learning uncovers the hybrid origin and biogeographic diversification of the plum genus. \textit{Systematic Biology}.

\item Gu J, Stevens S, Campolongo EG, Thompson MJ, Zhang N, Wu J, Kopanev A, Mai Z, \textbf{White AE}, Balhoff J, Dahdul W, Rubenstein D, Lapp H, Berger-Wolf T, Chao WL, Su Y. 2025. BioClip 2: Emergent Properties from Scaling Hierarchical Contrastive Learning. \textit{The Thirty-ninth Annual Conference on Neural Information Processing Systems (NeurIPS)}.\textit{*Spotlight paper}

\item Silva M*, Soto Balderas C, Leon B*, Castellanos M, Sillett TS, \textbf{White AE}. 2025. Designing fog collectors to understand impacts of changing precipitation patterns on the California Channel Islands. \textit{Western North American Naturalist}. 85, 205-215 \textit{*undergraduate mentee}
...
\item Rana SK, \textbf{White AE}, Price TD. Key roles for the freezing line and disturbance in driving the low plant species richness of temperate regions. 2022. \textit{Global Ecology and Biogeography}. 31, 280-293.
...
\begin{biblist}
\item Borowiec ML, Dikow RB, Frandsen PB, McKeeken A, Valentini G, \textbf{White AE}. 2022. Deep learning as a tool for ecology and evolution. \textit{Methods in Ecology and Evolution}. 13, 1640-1660.
...
\begin{itemize}
\item Smithsonian Latino Initiatives Pool, \textit{UCSB-Smithsonian Scholars Program: Professional Undergraduate Experiences in Data Science (PUEDES)}, 2025 (139,000 USD), *\textit{Co-PI}
...
\begin{biblist}
\item \emph{Data Science, Coffee, and Conservation}, field course, Boquete, Panama. University of California Santa Barbara-Smithsonian Scholars Program, August 2025
\item \emph{Data Science, Conservation, and Tropical Biology}, field course at the Smithsonian Tropical Research Institute, Panama City, Panama. University of California Santa Barbara-Smithsonian Scholars Program, August 2024 
...
\begin{itemize}
\item Marc-Elie Adaime (Smithsonian Data Science Lab; January 2025--)
\item Allan Cabrero (Smithsonian Data Science Lab; January 2025--)
\item William Mattingly (Smithsonian Data Science Lab; October 2023--January 2025)
\item Richard Hodel (Smithsonian Data Science Lab; October 2023--August 2024)
\end{itemize}
\subsection*{Undergraduate mentees}
\begin{itemize}
\item Kayla Geronimo-Anctil (Cal State Channel Islands; September 2025--)
\item Javier Medina Bueno (Cal Poly San Luis Obispo; June 2024--September 2024)
\item Daisy Contreras Martinez (UC Santa Barbara; June 2024--August 2024)
\item Rebecca Martinez (UC Santa Barbara; June 2024--August 2024
\item Richard Montes-Lemus (UC Santa Barbara; May 2023--August 2024)
...
\begin{biblist}
\item Panelist. \textit{Smithsonian AI Community of Practice: Testing and Evaluation for AI}. Abigail Haddad, Matthew Johnson, and \textbf{Alexander White}. Smithsonian Institution. Virtual, September 2025.
...
\begin{biblist}
\item \textbf{White, AE.} Artificial Intelligence applications to museum science at the Smithsonian. Watson Armour III Seminar. Field Museum of Natural History, April 2025.
...
\begin{biblist}
\item Member, AI Review Committee, Smithsonian Institution, 2024 - 
\item Co-author, Smithsonian AI Policy, Smithsonian Institution, 2025
\item Co-author, Smithsonian AI Handbook, Smithsonian Institution, 2025
\item Co-chair, AI Use Case Working Group, Smithsonian Institution, 2024
\end{biblist}
...
\begin{center}
  \begin{footnotesize}
    Last updated: \today \\
    \ifdefined\footerlink\ifx\footerlink\empty\else\href{\footerlink}{\texttt{\footerlink}}\fi\fi
  \end{footnotesize}
\end{center}
